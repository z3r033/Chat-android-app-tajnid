...
public class add_contact extends AppCompatActivity {
  private String jsonURL =UrlsGlobal.getnotinyourlist;//"http://10.0.0.1/chatbackend/getnotinyourlist.php";
  private String jsonURL2 = UrlsGlobal.ajouternvcontact; ; //"http://10.0.0.1/chatbackend/ajouternvcontact.php";
    ...
    private class Parser extends AsyncTask<Void, Void, Boolean> {
        ...
        private Boolean parsecontact() {
            try {
                ...
                int utilisateur_id = jo.getInt("utilisateur_id");
                String email = jo.getString("email");
                con= new modelutilisateur();
                con.setUsername(username);
                con.setImageurl(profile_url);
                con.setEmail(email);
                con.setUtilisateur_id(utilisateur_id);
...
//Toast.makeText(Contact.this,contact.get(0).getEmail(),Toast.LENGTH_LONG).show();
    ...
    private class ajoutercontact extends AsyncTask <Void,Void,String> {
        ...
        Context ct;
        public ajoutercontact(Context ctx, int utilisateur_id, int utilisateur_contact_id) {
